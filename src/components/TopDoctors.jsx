    ...
    return (
        <>
            <div className='text-center mt-9'>
                ...
                <p className='text-2xl'>Browse through the list of our trusted doctors.</p>
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 mt-5">
                    <Link to={'/doctors'}>
                ...
                <Link to={'/doctors'}>
                    <button className='mt-10 mb-10 text-xl bg-pink-600 text-white px-10 py-2 rounded-full font-light hidden:md:block'>More</button>
                </Link>
            </div>
        </>
    );
